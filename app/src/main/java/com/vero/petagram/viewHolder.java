...
public class viewHolder extends ViewHolder implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == btnLike.getId()){
            Toast.makeText(btnLike.getContext(), "Like a " +objeto.getTitulo(), Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(btnLike.getContext(), "Acumulaste likes " +objeto.getTitulo(), Toast.LENGTH_SHORT).show();
        }
